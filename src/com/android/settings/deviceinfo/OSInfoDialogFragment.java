...
public class OSInfoDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        TextView viper_version = content.findViewById(R.id.dev_info_viper_version);
        ...
        viper_version.setText(SystemProperties.get("ro.modversion"));
        ...
        LinearLayout viper_version_layout = content.findViewById(R.id.viper_version_layout);
        LinearLayout android_version_layout = content.findViewById(R.id.android_version_layout);
        viper_version_layout.setOnClickListener(new View.OnClickListener() {
            @Override
   ...
   public void updateVisibilities(View view) {
        ...
        LinearLayout viper_version_layout = view.findViewById(R.id.viper_version_layout);
        ...
        if (SystemProperties.get("ro.modversion").isEmpty()) {
            viper_version_layout.setVisibility(View.GONE);
        }
